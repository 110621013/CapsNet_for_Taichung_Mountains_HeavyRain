...
def load_myself(batch_size, is_training=True):
    ...
    if is_training:
        ...
        trX = trainX[:cut_num] / 255.
        trY = trainY[:cut_num]

        valX = trainX[cut_num:, ] / 255.
        valY = trainY[cut_num:]

        num_tr_batch = cut_num // batch_size
        num_val_batch = (train_num-cut_num) // batch_size
...
def get_batch_data(dataset, batch_size, num_threads):
    if dataset == 'mnist':
        ...
        trX, trY, num_tr_batch, valX, valY, num_val_batch = load_myself(batch_size, is_training=True)
